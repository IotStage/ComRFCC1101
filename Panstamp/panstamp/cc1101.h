...
class CC1101
{
  ...
  public:
     ...
     */
    void set_868_GFSK_1_2_K(void); // changer par guihini projet AIE
     ...
     */
    void set_868_GFSK_250_K(void); // changer par guihini projet AIE
     ...
     *    False otherwise
     */
    boolean sendData(CCPACKET packet); // changer par guihini projet AIE
