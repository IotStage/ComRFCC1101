...
* set_868_GFSK_1_2_K
* 
* Configure les registres CC1101 avec une frequence porteuse de 868 MHz une modulation GFSK et un debit de 1.2 Kbps
*/
void CC1101::set_868_GFSK_1_2_K(void) // changer par guihini projet AIE
{
  writeReg(CC1101_IOCFG2,  CC1101_DEFVAL_IOCFG2);
  writeReg(CC1101_IOCFG1,  CC1101_DEFVAL_IOCFG1);
  writeReg(CC1101_IOCFG0,  CC1101_DEFVAL_IOCFG0);
  ...
  // Set default synchronization word
  setSyncWord(0x57, 0x43, false);

  // Set default device address
  setDevAddress(0xFF, false);
  // Set default frequency channel
  setChannel(0x00, false);
...
* set_868_GFSK_250_K
* 
* Configure les registres CC1101 avec une frequence porteuse de 868 MHz une modulation GFSK et un debit de 250 Kbps
*/
void CC1101::set_868_GFSK_250_K(void) // changer par guihini projet AIE
{
  writeReg(CC1101_IOCFG2,  0x29);
  writeReg(CC1101_IOCFG1,  0x2E);
  writeReg(CC1101_IOCFG0,  0x06);
  writeReg(CC1101_FIFOTHR,  0x07);
  ...
  writeReg(CC1101_FSCTRL1,  0x12);
  writeReg(CC1101_FSCTRL0,  0x00);

  // Set default carrier frequency = 868 MHz
  setCarrierFreq(CFREQ_868);

  writeReg(CC1101_MDMCFG4,  0x2D);
  writeReg(CC1101_MDMCFG3,  0x3B);
  writeReg(CC1101_MDMCFG2,  0x93);
  writeReg(CC1101_MDMCFG1,  0x22);
  writeReg(CC1101_MDMCFG0,  0xF8);
  writeReg(CC1101_DEVIATN,  0x62);
 ...
 *    False otherwise
 */
boolean CC1101::sendData(CCPACKET packet) // changer par guihini projet AIE
{
  byte marcState;
  bool res = false;
